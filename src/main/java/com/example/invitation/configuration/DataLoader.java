...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Invitation invitation =new Invitation("Lovey Dovey","39/First Floor/167 Street /Tamwe,Yangon", Arrays.asList("09264239635"),
                Arrays.asList("ReadyMade (350/1000 ks)","HandMade (350/1000 ks)"),new Description(CategoryMade.Readymade,1000,350),
                new Description(CategoryMade.handmade,1000,350),
        ...
        Invitation santhawthar =new Invitation("San Thaw Thar","19st (upper block),Yangon",Arrays.asList("095120488"),
                ...
                Arrays.asList(new Description(CategoryMade.Readymade,1000,500),new Description(CategoryMade.handmade,1000,500),
        ...
        Invitation loveforlove =new Invitation("Love for Love","No.137,31st (middle),Pabedan Tsp,Ygn",Arrays.asList("09798108014"),
                ...
                Arrays.asList(new Description(CategoryMade.Readymade,1000,350),new Description(CategoryMade.handmade,1000,350),
